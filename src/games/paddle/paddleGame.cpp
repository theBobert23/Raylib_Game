...
paddleGame :: paddleGame(GameType type){
	...
	Player = new Paddle(ObjectSide::Left, Type::Human);
	Player2 = type == GameType::SinglePlayer ? new Paddle(ObjectSide::Right, Type::Computer) : new Paddle(ObjectSide::Right, Type::Human);
